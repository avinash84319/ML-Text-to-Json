...
def generate_query_structure_without(location_type):
    return random.choice([
        "Find {keyword} {preposition} me.",
        "Where is {keyword} {preposition} me?",
        "Looking for {keyword} {preposition} me.",
        "Help me {verb} {keyword} {preposition} me.",
        "I'm {verb} {preposition} me.",
        "Tell me {keyword} {preposition} me.",
        "{verb} {keyword} {preposition} me.",
        "Looking to {verb} {keyword} {preposition} me."
    ])

def generate_query_without(location_type):
    ...
    # if location_type == "near":
    #     query += f" Need {random.choice(['doctor', 'hospital', 'help'])}."
    # elif location_type == "in":
    #     query += f" I need {random.choice(['hospital', 'help', 'doctor'])}."
    # elif location_type == "around":
    #     query += f" I want {random.choice(['help', 'doctor', 'information'])}."
    # elif location_type == "close_to":
    #     query += f" Tell me {random.choice(['appointments', 'information', 'schedule'])}."
    # elif location_type == "within":
    #     query += f" Check {random.choice(['records', 'history', 'information'])}."
